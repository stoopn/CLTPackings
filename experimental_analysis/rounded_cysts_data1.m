...
%%
save('names_rounded_data1.mat', 'names', 'matrixfreq', 'neggchambers', 'orderedeggchambers', 'matrix');
save('ADJ_experiment_rounded_data1.mat','matrix','matrixfreq', 'neggchambers'); 
